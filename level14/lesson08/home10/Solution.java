...
public class Solution
{
    ...
    {
        private List<Number> initList(List<Number> list1)
        {

            //1
            list1.add(new Double(1000f));
            list1.add(new Double("123e-445632"));
            list1.add(new Float(-90 / -3));
            list1.remove(new Double("123e-445632"));
            return list1;
        }
