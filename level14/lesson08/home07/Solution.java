...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament aApartament : apartaments)
        {
            if (aApartament instanceof Apt1Room){((Apt1Room) aApartament).clean1Room();}
            if (aApartament instanceof Apt2Room){((Apt2Room) aApartament).clean2Rooms();}
            if (aApartament instanceof Apt3Room){((Apt3Room) aApartament).clean3Rooms();}
        }
    }
